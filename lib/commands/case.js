/**
 * Copyright (C) 2025 lilnem
 *
 * This code is licensed under the MIT License.
 * See the LICENSE file in the repository root for full license text.
 *
 * Lilnem-MD WhatsApp BoT BASE 
 * Version: 1.0.0
 * Created by lilnem
 * GitHub: https://github.com/kokoloo/Lilnem-xmd
 */
...
END:VCARD`,
    ...
    // Fix pour les messages bot owner à bot owner
    const isOwnerToOwner = ownerNumbers.includes(m.sender) && ownerNumbers.includes(conn.user.id);

    // Autoriser les commandes même si c'est owner à owner
    if (isOwnerToOwner && body.startsWith(prefix)) {
      // Forcer le traitement de la commande
      m.isOwner = true;
    }
