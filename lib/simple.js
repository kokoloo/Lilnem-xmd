...
export function serialize() {
    ...
    return Object.defineProperties(proto.WebMessageInfo.prototype, {
        ...
        isBaileys: {
            get() {
                return this.id?.startsWith(messId) && this.id?.length === 22 || false
            }
        },
        chat: {
            get() {
                ...
                return Object.defineProperties(JSON.parse(JSON.stringify(typeof q === 'string' ? {
                    ...
                    command: {
                        get() {
                            ...
                            let result = (match[0] || "")[0] || (match[0] || "")[0]
        ...
        isBot: {
            get() {
                ...
                return ["3EB"].some(k => idBot.includes(k) && this.sender !== this.conn?.user.jid);
            },
            enumerable: true
        }
    })
